...
public:
	...
	void setGyroCal(float scale, float calG[3]) {
	...
	void setAccelCal(float scale, float calA[3]) {
        //cal[0]=calA[0] * G_PER_COUNT;
        //cal[1]=calA[1] * G_PER_COUNT;
        //cal[2]=calA[2] * G_PER_COUNT;
        
        cal[0]=calA[0] * scale;
        cal[1]=calA[1] * scale;
        cal[2]=calA[2] * scale;
    }    
	void setMagCal(float scale, float calM[3]) {
        //cal[6]=calM[0] * UT_PER_COUNT;
        //cal[7]=calM[1] * UT_PER_COUNT;
        //cal[8]=calM[2] * UT_PER_COUNT;
